...
out.push(check('.skin-view[data-skin="classical"] #works-classical .grid .card:nth-of-type(15)', 'classical-card-15'));
out.push(check('.skin-view[data-skin="starry"] #works-starry .grid .card:nth-of-type(15)', 'starry-card-15'));
...
out.push(check('.skin-view[data-skin="terminal"] .term-body > .tblk:last-of-type .cmd-out .line', 'zh-visitors'));
